...
export const updateCallbackTriggerMutation = gql`
  mutation updateCallbackTriggerMutation(
...
export const toggleHideCallbackMutations = gql`
  mutation hideCallback($callback_display_id: Int!, $active: Boolean!) {
    updateCallback(
      input: { callback_display_id: $callback_display_id, active: $active }
    ) {
      status
      error
    }
...
export const updateDescriptionCallbackMutation = gql`
  mutation updateDescriptionCallback(
    $callback_display_id: Int!
    $description: String!
    $color: String!
  ) {
...
export const updateSleepInfoCallbackMutation = gql`
  mutation updateSleepInfoCallback(
    $callback_display_id: Int!
    $sleep_info: String!
  ) {
    updateCallback(
      input: { callback_display_id: $callback_display_id, sleep_info: $sleep_info }
    ) {
      status
      error
    }
...
export const taskingDataFragment = gql`
  fragment taskData on task {
    ...
    tasks(
      where: { is_interactive_task: { _eq: false } }
      order_by: { id: asc }
    ) {
      id
      comment
