    ...
    <React.Fragment>
      ...
      <DialogContent dividers={true} style={{ height: "100%", margin: 0, padding: 0 }}>
        ...
        <Box sx={{ width: "100%", height: 25, backgroundColor: color }} >
          <Typography style={{ color: "white", display: "inline-block", marginRight: "10px" }}>深色模式文本（带颜色背景）</Typography>
          <Typography style={{ color: "black", display: "inline-block" }}>浅色模式文本（带颜色背景）</Typography>
        </Box>
      </DialogContent>
      <DialogActions>
