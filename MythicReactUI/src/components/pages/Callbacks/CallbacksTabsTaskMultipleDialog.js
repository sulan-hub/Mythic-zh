...
export function CallbacksTabsTaskMultipleDialog({ onClose, callback }) {
    ...
    useQuery(callbacksAndFeaturesQuery, {
        variables: { payloadtype_id: callback.payload.payloadtype.id },
    ...
    return (
        <React.Fragment>
            <DialogTitle id="form-dialog-title">批量任务 - 同时执行 {callback.payload.payloadtype.name} 回连</DialogTitle>
